...
projects = {
    "iminbak-web": {
        ...
        "hosts": ["localhost"],
        "java_opts": "-Djava.awt.headless=true -Dfile.encoding=UTF-8 -server -Xms256m -Xmx512m -XX:NewSize=128m -XX:MaxNewSize=256m -XX:+DisableExplicitGC"
    }    
}
...
def copy():
    ...
    local('cp -r ./target/iminbak/. %(current_release)s/' % {'current_release':env.current_release}) # file copy
